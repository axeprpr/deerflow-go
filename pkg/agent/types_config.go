...
var BuiltinAgentTypes = map[AgentType]AgentTypeConfig{
	...
	AgentTypeCoder: {
		...
		DefaultTools: []string{"bash", "read_file", "write_file", "glob", "present_files", "ask_clarification", "task"},
		MaxTurns:     12,
		Temperature:  0.1,
	},
	AgentTypeAnalyst: {
		...
		DefaultTools: []string{"read_file", "write_file", "glob", "present_files", "ask_clarification"},
		MaxTurns:     10,
		Temperature:  0.15,
	},
}
