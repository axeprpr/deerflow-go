...
var BuiltinAgentTypes = map[AgentType]AgentTypeConfig{
	...
	AgentTypeResearch: {
		...
		DefaultTools: []string{"web_search", "web_fetch", "image_search", "ls", "read_file", "glob", "grep", "present_files", "ask_clarification", "task"},
		MaxTurns:     10,
		Temperature:  0.1,
	},
	AgentTypeCoder: {
		...
		DefaultTools: []string{"bash", "ls", "read_file", "glob", "grep", "write_file", "str_replace", "present_files", "ask_clarification", "task"},
		MaxTurns:     12,
		Temperature:  0.1,
	},
	AgentTypeAnalyst: {
		...
		DefaultTools: []string{"ls", "read_file", "glob", "grep", "write_file", "str_replace", "present_files", "ask_clarification"},
		MaxTurns:     10,
		Temperature:  0.15,
	},
}
