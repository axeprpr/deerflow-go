...
func TestWorkerPlanCodecRoundTripPortablePlan(t *testing.T) {
	...
	plan := NewWorkerExecutionPlan(RunPlan{
		...
		Spec:             harness.AgentSpec{ExecutionMode: "background", AgentType: agent.AgentTypeGeneral, SystemPrompt: "system", Temperature: &temp, MaxTokens: &maxTokens, PresentFiles: registry},
